...
enum L10n {
    ...
    private static let english: [String: String] = [
        ...
        "liveUsageCaption": "OpenAI and Anthropic can use live organization usage with admin keys. Providers without adapters stay visible with honest source states.",
        "liveData": "Live data",
    ...
    private static let chinese: [String: String] = [
        ...
        "liveUsageCaption": "OpenAI 和 Anthropic 可通过管理员密钥读取组织级真实用量；未接入的平台会保留并显示真实来源状态。",
        "liveData": "实时数据",
