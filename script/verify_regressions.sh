...
"$ROOT_DIR/script/verify_persistence_stores.sh"
...
ruby "$ROOT_DIR/script/verify_policy_contract.rb"
"$ROOT_DIR/script/verify_policy_contract.sh"
ruby "$ROOT_DIR/script/verify_local_api_client.rb"
"$ROOT_DIR/script/verify_claude_policy_hook.sh"
"$ROOT_DIR/script/verify_release_path_guard.sh"
